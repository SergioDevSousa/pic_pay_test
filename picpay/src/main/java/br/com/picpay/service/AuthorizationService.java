...
public class AuthorizationService {
    ...
    public AuthorizationService(
            @Value("${picpay.authorization.url:https://util.devi.tools/api/v2/authorize}")
    ...
    public boolean authorize() {
        ...
        try {
            AuthorizationResponse response = restClient
                    .get()
            ...
            if (response == null || response.data() == null) {
                throw new BusinessException(
                        "Resposta inválida do serviço autorizador"
                );
            }
